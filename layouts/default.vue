...
<v-app>
   ...
   <LayoutFooter />
   <v-btn class="fab mb-6" :size="$vuetify.breakpoint.xs ? 'small' : 'large'" color="primary" icon to="#top">
    <v-icon>mdi-arrow-up-thick</v-icon>
        </v-btn>
        <v-btn class="fab whatsapp mb-8" :size="$vuetify.breakpoint.xs ? 'small' : 'large'" icon
