        ...
        <v-card flat tile class="card-surface pt-2">
            <v-form v-model="validBanner" v-on:submit.prevent="saveBanner">
                        ...
                        <v-row dense>
                            <v-col>
                                <v-text-field dense outlined class="body-1" background-color="foreground" required
                                    :rules="rulesGlobal.required" v-model="banner.name" label="Nombre"
                                    color="secondary"></v-text-field>
                                <v-select dense outlined class="body-1" background-color="foreground"
                                    v-model="banner.category" :items="categories" return-object item-text="name"
                                    label="Categoría" color="secondary"></v-select>
                                <v-text-field dense outlined class="body-1" background-color="foreground"
                                    v-model="banner.url" label="Link" color="secondary"></v-text-field>
                            </v-col>
                        </v-row>
                        <v-row dense>
                            <v-col>
                                <h5 class="body-1 pa-3">Imagen desktop</h5>
                                <v-file-input dense v-model="banner.file" placeholder="Seleccione su archivo"
                            ...
                            <v-col>
                                ...
                                <v-file-input dense v-model="banner.fileMobile" placeholder="Seleccione su archivo"
                                    accept="image/*" color="secondary" background-color="foreground" outlined
                ...
                <v-card-actions class="justify-center background">
                    <v-btn large color="primary" type="submit" :disabled="!validBanner || processingImg"
